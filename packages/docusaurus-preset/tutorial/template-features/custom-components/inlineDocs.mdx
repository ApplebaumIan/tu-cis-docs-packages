...
import {InlineDocs} from '@tu-cis-courses/docusaurus-components';
...
<a href="https://github.com/ApplebaumIan/tu-cis-docs-packages/blob/main/.github/workflows/deployWithDocs.yml.disabled">
  Example
</a>
